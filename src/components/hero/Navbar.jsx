  ...
  return (
    ...
    <div className='max-w-7xl mx-auto py-6 flex items-center justify-between'>
      <div className='flex items-center gap-1'>
        <img className='w-8 mb-1' src={images.logo} alt='logo/floravision' />
        <div className='font-bold text-2xl'>FloraVision.</div>
      </div>

      <nav className='relative group font-navbar'>
        <ul className='hidden md:flex items-center gap-8 font-regular text-lg text-white'>
          ...
          border-l-5 border-l-white rotate-90'>
          </li>
          </a>
