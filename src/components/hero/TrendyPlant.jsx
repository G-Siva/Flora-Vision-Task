  ...
  return (
    <section className="min-h-screen max-w-7xl mx-auto mt-8 px-4 lg:px-0">
      ...
      <GlassCard className="mt-10 mx-auto w-full min-h-[400px] p-6 flex flex-col items-center justify-center gap-4 relative overflow-hidden rounded-3xl 
        ...
        {/* Plant Image Left/Bottom */}
        <img
          className="w-48 h-auto object-contain drop-shadow-xl z-10
                     lg:w-110 lg:h-auto lg:absolute lg:-left-6 lg:-bottom-2"
          src={images.plant2}
          alt="Trendy_plant"
        />

        {/* Right Side Text/Top */}
        <div className="text-white max-w-xs text-center z-20 
                        lg:ml-auto lg:max-w-sm lg:text-left">
      ...
      <GlassCard className="mt-12 mx-auto w-full min-h-[400px] p-6 flex flex-col items-center justify-center gap-4 relative overflow-hidden rounded-3xl 
        ...
        {/* Plant Image Right/Bottom */}
        <img
          className="w-48 h-auto object-contain drop-shadow-xl z-10
                     lg:w-110 lg:h-auto lg:absolute lg:-right-6 lg:-bottom-10"
