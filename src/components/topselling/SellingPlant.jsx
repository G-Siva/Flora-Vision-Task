...
const plants = [
  ...
  },
  {
    ...
    desc: "A popular tropical houseplant known for its distinctive perforated leaves.",
    price: "400",
  },
  {
    src: images.plant5,
    title: "Sansevieria plant",
    desc: "A popular indoor plant known for its striking appearance and low-maintenance nature.",
    price: "450",
  },
  {
    src: images.plant6,
    title: "Agave plant",
    desc: "Agave plants are succulents known for their architectural thick rosette leaves.",
    price: "359",
  },
];
          ...
          <div key={idx} className="relative flex flex-col items-center">
            ...
            <div className="absolute -top-16 z-20">
              <img
                src={p.src}
                alt={p.title}
                className="w-48 sm:w-40 lg:w-48 object-contain drop-shadow-2xl"
              />
            </div>
            ...
            <GlassCard
              className="
                w-[300px] min-h-[330px] pt-20 p-6 rounded-[40px] bg-white/10 border border-white/20 backdrop-blur-xl shadow-xltext-white"
            >
